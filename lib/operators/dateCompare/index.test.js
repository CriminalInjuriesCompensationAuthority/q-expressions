...
describe('dateCompare', () => {
    ...
    it('should return undefined if the answer is undefined', () => {
        const expression = [
            'dateCompare',
            '$.answers.section1.q1', // this date ...
            '>', // is more than ...
        ...
        const noQuestionIdResult = qExpression.evaluate(expression, noQuestionId);
        const noPageIdResult = qExpression.evaluate(expression, noPageId);
        const noAnswersResult = qExpression.evaluate(expression, {});

        expect(noQuestionIdResult).toEqual(undefined);
        expect(noPageIdResult).toEqual(undefined);
        expect(noAnswersResult).toEqual(undefined);
    });
});
